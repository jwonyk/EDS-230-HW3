...
price_sample <- pmax(rnorm(n_sample, mean = 2100, sd = 250), 0)
cost_sample <- pmax(rnorm(n_sample, mean = 1500, sd = 200), 0)
...
```{r}
# For each sampled price and cost, recompute yield-driven profit and store mean annual profit
